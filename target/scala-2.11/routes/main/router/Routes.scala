...
class Routes(
  ...
  // @LINE:13
  private[this] lazy val controllers_Application_businessSignup6_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("business_signup")))
  )
  private[this] lazy val controllers_Application_businessSignup6_invoker = createInvoker(
    Application_2.businessSignup(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "businessSignup",
  ...
  // @LINE:14
  private[this] lazy val controllers_Application_postBusinessSignup7_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("business_signup")))
  )
  private[this] lazy val controllers_Application_postBusinessSignup7_invoker = createInvoker(
    Application_2.postBusinessSignup(),
    HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "postBusinessSignup",
  ...
  // @LINE:20
  private[this] lazy val controllers_HomeController_list9_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("coupons")))
  )
  private[this] lazy val controllers_HomeController_list9_invoker = createInvoker(
  ...
  // @LINE:23
  private[this] lazy val controllers_HomeController_create10_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("coupons/new")))
  )
  private[this] lazy val controllers_HomeController_create10_invoker = createInvoker(
  ...
  // @LINE:24
  private[this] lazy val controllers_HomeController_save11_route = Route("POST",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("coupons")))
  )
  private[this] lazy val controllers_HomeController_save11_invoker = createInvoker(
  ...
  // @LINE:31
  private[this] lazy val controllers_HomeController_delete14_route = Route("POST",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:13
    case controllers_Application_businessSignup6_route(params) =>
      call { 
        controllers_Application_businessSignup6_invoker.call(Application_2.businessSignup())
      }
  
    // @LINE:14
    case controllers_Application_postBusinessSignup7_route(params) =>
      call { 
        controllers_Application_postBusinessSignup7_invoker.call(Application_2.postBusinessSignup())
      }
    ...
    // @LINE:20
    case controllers_HomeController_list9_route(params) =>
      call(params.fromQuery[Int]("p", Some(0)), params.fromQuery[String]("s", Some("name")), params.fromQuery[String]("o", Some("asc")), params.fromQuery[String]("f", Some(""))) { (p, s, o, f) =>
        controllers_HomeController_list9_invoker.call(HomeController_0.list(p, s, o, f))
      }
  
    // @LINE:23
    case controllers_HomeController_create10_route(params) =>
      call { 
        controllers_HomeController_create10_invoker.call(HomeController_0.create())
      }
  
    // @LINE:24
    case controllers_HomeController_save11_route(params) =>
      call { 
        controllers_HomeController_save11_invoker.call(HomeController_0.save())
      }
  
    // @LINE:27
    case controllers_HomeController_edit12_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_edit12_invoker.call(HomeController_0.edit(id))
      }
  
    // @LINE:28
    case controllers_HomeController_update13_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_update13_invoker.call(HomeController_0.update(id))
      }
  
    // @LINE:31
    case controllers_HomeController_delete14_route(params) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_HomeController_delete14_invoker.call(HomeController_0.delete(id))
      }
  }
}
